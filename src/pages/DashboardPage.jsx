        ...
        {stats.map((s, i) => (
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <div
                className={`text-xs font-mono ${s.text} bg-white/5 rounded-full px-2 py-0.5`}
              >
                {s.sub}
              </div>
            </div>
            ...
            {documents.length === 0 ? (
              ...
              documents.slice(0, 4).map((doc, i) => (
                <button
                  ...
                  onMouseEnter={() => setHoveredDoc(doc.id || doc._id)}
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-indigo-500/20 flex items-center justify-center text-lg flex-shrink-0">
                    📄
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-slate-500 mt-0.5">
                      {doc.pages || 0} pages ·{' '}
                      {formatBytes(doc.size || doc.fileSize || 0)} ·{' '}
                      {timeAgo(doc.uploadedAt || doc.createdAt)}
                    </div>
                  </div>
          ...
          <div className="space-y-2">
            {quizzes.length === 0 ? (
              ...
              quizzes.slice(0, 4).map((q, i) => {
                const pct =
                  q.latestScore === null || q.latestScore === undefined
                    ? null
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      {pct === null ? (
                        <div className="text-xs text-slate-500 bg-white/5 rounded-full px-2 py-0.5">
                          Pending
                        </div>
                      ) : (
                        <div
